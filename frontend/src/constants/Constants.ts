...
export const SELECT_QUIZ_OPTION = "Select Answer";
...
export const QUIZ_PLAYED_AT = "Played On";
export const QUIZ_PERCENTAGE = "Percentage";
export const QUIZ_CORRECT_QUESTIONS = "Correct Answers";
export const QUIZ_MISSED_QUESTIONS = "Missed Answers";

export const USER_NAME = "Name";
export const USER_PROVIDER = "Source";
...
export const AUTHORIZED_FILE_FORMAT = "Allowed file format: ";

export const BANNER_MESSAGE = "Test your knowledge with our curated quizzes!";
export const BANNER_SUBMESSAGE =
  "With new quizzes added regularly, there's always something new to discover. Try a new quiz every day and see how much you can learn!";
export const BANNER_BUTTON = "Explore Our Quizzes";

export const HOME_PAGE_TITLE = "Nos Quiz";
...
export const LOGGED_IN_RESERVED_PAGE =
  "You must be logged in to access this page";
export const ALL_RIGHTS_RESERVED = `© ${new Date().getFullYear()} Quizz App. All rights reserved`;
